...
const Login =()=>{
   ...
   /* const registrar=(email,contraseña)=>{
                        ...
                        <div className="row justify-content-center ">
                            <div className="col-lg-5 mb-5">
                                <div className="card shadow-lg border-0 rounded-lg mt-5">
                                    <div className="card-header"><h3 className="text-center font-weight-light my-4">Login turista</h3></div>
